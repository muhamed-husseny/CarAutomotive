        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    BasePriceEgp = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
                    SalePriceEgp = table.Column<decimal>(type: "numeric(12,2)", nullable: true),
                    ItemCostEgp = table.Column<decimal>(type: "numeric(12,2)", nullable: true),
                    StockQuantity = table.Column<int>(type: "integer", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    MerchantId = table.Column<Guid>(type: "uuid", nullable: true),
                    OuterDiameterMM = table.Column<decimal>(type: "numeric(12,2)", nullable: true),
                    ThicknessMM = table.Column<decimal>(type: "numeric(12,2)", nullable: true),
                    BoltHoleCircleMM = table.Column<decimal>(type: "numeric(12,2)", nullable: true),
                    LengthMM = table.Column<decimal>(type: "numeric(12,2)", nullable: true),
                    ThreadSize = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    VinCompatibilityPattern = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    IsVisible = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    WorkshopDeliveryEnabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_MechanicProfiles_MechanicId",
                        column: x => x.MechanicId,
                        principalTable: "MechanicProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Model = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Year = table.Column<int>(type: "integer", nullable: false),
                    PlateCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountEgp = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
                    Status = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletLedgers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
